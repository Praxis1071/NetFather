...
class DiscoveryConfig:
    ...
    live_presence_enabled: bool = True
    live_presence_interval_seconds: int = 30
    def __post_init__(self) -> None:
        ...
        if self.live_presence_interval_seconds < 3:
            raise ConfigError("live_presence_interval_seconds en az 3 saniye olmalıdır.")
